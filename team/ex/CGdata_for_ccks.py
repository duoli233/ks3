...
def parse_args():
    ...
    # setting for openai
    parser.add_argument('--openai_url', default="https://api.gpt.ge/v1/", type=str, help='The url of openai')
    ...
    parser.add_argument('--retriever_align', default="text-embedding-ada-002", type=str, help='The retriever used for alignment')
    ...
    parser.add_argument('--output_detail_path', default="output/test/output_detail", type=str)
    parser.add_argument('--output_result_path', default="output/test/output_result", type=str)
    ...
    #others
    parser.add_argument('--num_process', default=10, type=int, help='the number of multi-process')
...
if __name__=="__main__":
    ...
    args.data_path = 'dataset/CCKS_round1/test_qa.json'
    # get API key
